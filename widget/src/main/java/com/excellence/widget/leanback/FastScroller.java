...
/**
 * Class responsible to animate and provide a fast scroller. {@link androidx.recyclerview.widget.FastScroller}
 */
@VisibleForTesting
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    private static final int MIN_SCROLL_THUMB_HEIGHT = 30;
    ...
    void updateScrollPosition(int offsetX, int offsetY) {
        ...
        if (mNeedVerticalScrollbar) {
            ...
            if (mVerticalThumbHeight < MIN_SCROLL_THUMB_HEIGHT) {
                mVerticalThumbHeight = MIN_SCROLL_THUMB_HEIGHT;
            }
        }
